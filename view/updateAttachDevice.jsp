            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form role="form" action="/attachDevices?method=update" method="post">
                                    <%
                                       AttachDeviceInfo attachDeviceInfo=new AttachDeviceInfoService().getAttachDeviceInfo(request.getParameter("deviceID"));
                                    %>
                                    <input type="hidden" name="deviceID" value=<%=attachDeviceInfo.getDeviceID()%>/>
