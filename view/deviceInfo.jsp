                            ...
                            <%
                                ...
                                for (DeviceInfo deviceInfo : results){
                                    out.print("<tr class=\"odd gradeX\">\n" +
                                            ...
                                            "       <td><a href=\"/device?method=delete&deviceId=" + deviceInfo.getDeviceID() + "\">删除</a>&nbsp;&nbsp;" +
                                            (deviceInfo.getDepartmentID() == null || deviceInfo.getDepartmentID().equals("") ?
                                            "       <a href=\"/device?method=requestUse&deviceId=" + deviceInfo.getDeviceID() + "\">申请使用</a>&nbsp;&nbsp;" +
                                            "       <a href=\"/device?method=updateTo&deviceId=" + deviceInfo.getDeviceID() + "\">修改</a>" :
                                            "") +
                                            "       </td>" +
                                            "   </tr>");
                                }
